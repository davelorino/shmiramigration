    ...
    const peopleFormOptions = [
        {
            key: '0',
            value: 'Create',
            text: 'Create an account for a new starter',
        },
        {
            key: '1',
            value: 'Add to Project',
            text: 'Give someone access to a project',
        },
    ]
    ...
    return (
        <>
            ...
            <Select
                ...
                onChange={(e, { value }) =>
                    handlePeopleFormSelectedOption(e, value)
                }
            />

            {selectedPeopleFormOption === 'Create' && <NewUserForm />}
            {selectedPeopleFormOption === 'Add to Project' && (
                <GrantUserAccessForm />
            )}
        </>
    )

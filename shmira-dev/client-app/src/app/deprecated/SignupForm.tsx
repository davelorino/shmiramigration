...
import '../features/forms/Login/login.css'
import Icon from '../images/Icon'
import SignUpButton from '../images/SignUpButton'
import GoogleSignUpButton from '../images/GoogleSignUpButton'
                ...
                <form ref={form} onSubmit={(e) => handleSubmit(e)}>
                    ...
                    >
                        ...
                        <input
                            ...
                            onChange={(e) => {
                                setError('')
                                setSecondNameState(e.target.value)
                            }}
                            style={{
                                border: '0.5px solid',
                                marginBottom: '0px',
            ...
            */}
            ...
            {activateYourAccount === true && (
                ...
                >
                    ...
                    >
                        <h5 style={{ top: '60px' }}>
                            Check your emails for a link to activate your
                            account.
                        </h5>
                    </div>
                </div>

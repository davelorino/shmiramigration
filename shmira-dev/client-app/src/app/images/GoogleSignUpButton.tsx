...
const createSvgIcon = (Component: any) => (size: any, color: any) => {
    if (typeof Component === 'string') {
        return createSvgIcon(Image((Component = Component)))
    }
    return <Component width="20px" height="20px" color={color} />
}

function Image(Component: any, props?: any) {
    return <img src={Component} width="20px" height="20px" />
}
...
const GoogleSignUpButton = createButton(config)

function Icon(width: any, height: any) {
    return (
        <svg

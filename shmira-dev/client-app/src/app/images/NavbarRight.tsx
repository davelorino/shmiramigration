...
import IssueForm from '../features/forms/CreateIssueForm'
import SprintForm from '../features/forms/SprintForm'
import PeopleForm from '../features/forms/PeopleForm'
import EditProjectForm from '../features/forms/EditProjectForm'
import NewUserForm from '../features/forms/CreatePeopleForm'
    ...
    return (
      ...
      */}
            ...
            <Item
                ...
                style={{ lineHeight: '30px', height: '60px' }}
            >
                ...
                >
                    {issueStore.selectedProject?.name}
                </ItemText>
                <p
                    style={{
                        display: 'flex',
            ...
            <Item
                onClick={() =>
                    mediumModalStore.openMediumModal(<EditProjectForm />)
                }
            >

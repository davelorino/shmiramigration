...
export default observer(function NewCreateIssueForm() {
    ...
    var [selectedIssueEstimatedDays, setSelectedIssueEstimatedDays] =
        useState(0)
    var [selectedIssueEstimatedHours, setSelectedIssueEstimatedHours] =
        useState(0)
    var [selectedIssueEstimatedMinutes, setSelectedIssueEstimatedMinutes] =
        useState(0)
                            ...
                            <Grid.Column width={6}>
                                ...
                                {selectedAssignees.map((user_id, index) => (
                                    <StyledLabel
                                        ...
                                        onClick={() => {
                                            removeAssigneeFromIssue(user_id)
                                        }}
                                    >
                                        <AvatarIsActiveLabelBorder
                                            isActive={false}

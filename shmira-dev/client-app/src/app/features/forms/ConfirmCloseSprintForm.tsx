...
export default observer(function ConfirmCloseSprintForm() {
    ...
    const { selectedIssue, selectedProject, selectedSprint } = issueStore
    ...
    function handleCloseSprint() {
        var project_sprint: ProjectSprintAndBacklog = {
            ...
            backlog_id: selectedProject!.sprints.find(
        ...
        <div>
            ...
            >
                {({ handleSubmit, isValid, isSubmitting, dirty }) => (
                    ...
                    >
                        <h5>
                            Are you sure you want to complete the sprint? Any
                            remaining tickets will be moved to the backlog.
                        </h5>
                        ...
                        <Button
                            size="tiny"
                            content="Cancel"
                            onClick={() => smallModalStore.closeSmallModal}
                            float="center"
                        />
                    </Form>
                )}

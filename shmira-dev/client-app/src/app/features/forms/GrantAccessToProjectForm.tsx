...
export default observer(function GrantUserAccessForm() {
    ...
    const { allUsers, user_loading } = userStore
                ...
                {({ handleSubmit, isValid, isSubmitting, dirty }) => (
                    ...
                    >
                        <MyMultipleSelectInput
                            placeholder="Select the users that you want to grant access to"
                            options={reformatAssigneeOptions(allUsers)}
                            label="Users"
                            name="AssigneeIds"
                        />

                        <MyMultipleSelectInput
                            placeholder="Select the projects that you want to grant user access to"

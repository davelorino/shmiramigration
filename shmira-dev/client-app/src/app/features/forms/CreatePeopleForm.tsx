...
export default observer(function NewUserForm() {
    ...
    const { allProjects } = issueStore

    const { createUser, user_loading } = userStore
    ...
    const validationSchema = Yup.object({
        ...
        email: Yup.string()
            .email()
            .required(
                'An email is required so the new account holder can activate their account and set a password.'
            ),
    })
    ...
    return (
        <Segment clearing>
            ...
            We will send the new account holder an email so they can activate
            their account and set a password.
            <br />
            <br></br>
            <Formik
